...
- [`rstantools-package`](https://mc-stan.org/rstantools/reference/rstantools-package.md)
...
- [`rstantools_load_code()`](https://mc-stan.org/rstantools/reference/rstantools_load_code.md)
...
- [`bayes_R2()`](https://mc-stan.org/rstantools/reference/bayes_R2.md)
  [`loo_R2()`](https://mc-stan.org/rstantools/reference/bayes_R2.md) :
  Generic function and default method for Bayesian R-squared
- [`log_lik()`](https://mc-stan.org/rstantools/reference/log_lik.md) :
...
- [`posterior_linpred()`](https://mc-stan.org/rstantools/reference/posterior_linpred.md)
  : Generic function for accessing the posterior distribution of the
  linear predictor
- [`posterior_predict()`](https://mc-stan.org/rstantools/reference/posterior_predict.md)
  ...
  distribution
- [`predictive_error()`](https://mc-stan.org/rstantools/reference/predictive_error.md)
  : Generic function and default method for predictive errors
- [`predictive_interval()`](https://mc-stan.org/rstantools/reference/predictive_interval.md)
  : Generic function for predictive intervals
- [`prior_summary()`](https://mc-stan.org/rstantools/reference/prior_summary.md)
