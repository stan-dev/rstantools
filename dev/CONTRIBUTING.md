# Contributing to rstantools

This outlines how to propose a change to rstantools and is based on
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("stan-dev/rstantools", fork = TRUE)`.
...
Please note that the rstantools project follows the Stan project’s [Code
of
