...
```
    ...
    This is rstantools version 2.5.0.9000
...
This can be done with the function `devtools::document()`.
...
```
    ...
    Chain 2:                0.478 seconds (Sampling)
    Chain 2:                1.066 seconds (Total)
    Chain 2: 
...
```
    ...
    Samples were drawn using NUTS(diag_e) at Wed Dec  3 18:50:47 2025.
