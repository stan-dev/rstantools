...
```
    ...
    Chain 4: 
    Chain 4:  Elapsed Time: 0.575 seconds (Warm-up)
    Chain 4:                0.625 seconds (Sampling)
    Chain 4:                1.2 seconds (Total)
    Chain 4: 
...
```
    ...
    Samples were drawn using NUTS(diag_e) at Tue Dec  9 17:44:36 2025.
