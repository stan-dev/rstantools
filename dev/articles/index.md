...
- [Guidelines for Developers of R Packages Interfacing with
  Stan](https://mc-stan.org/rstantools/dev/articles/developer-guidelines.md):
...
adding the precompiled Stan program and writing the R function that
users will call to fit the model.

- [Step by step guide for creating a package that depends on
  RStan](https://mc-stan.org/rstantools/dev/articles/minimal-rstan-package.md):
