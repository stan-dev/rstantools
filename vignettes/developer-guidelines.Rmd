...
soon serve as the back-end for plotting for our various R packages and we hope
developers of other Stan-based R packages will also use it. For any plot you
