...
as a template and/or ask us for help on the [Stan users 
group](https://groups.google.com/forum/#!forum/stan-users).
...
[__rstanarm__](https://github.com/stan-dev/rstanarm) for examples).
...
[stan-dev/bayesplot](github.com/stan-dev/bayesplot)). We hope developers of
