...
__Note:__ For newer versions of __roxygen__, it is necessary to compile the
package C++ code prior to running `roxygen2::roxygenize()`.  One way to do this
is with `pkgbuild::compile_dll()`, as above.
...
```{r,eval=FALSE}
# usiing ../rstanlm because already inside the rstanlm directory
